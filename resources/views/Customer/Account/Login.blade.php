                    ...
                    <h1>Login US</h1>
                        <div class="page__title-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"> Lpgin</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="login-action mb-20 fix">
                                <span class="forgot-login f-right">
                                    <a href="{{route('get_email_to_repasscus')}}">Lost your password?</a>
                                </span>
                            </div>
                            <button type="submit" class="os-btn w-100">Login Now</button>
                            <div class="or-divide"><span>or</span></div>
                            <div class="register" style="display: flex;">
                                <a href="{{route('registercus')}}" class="os-btn os-btn-black w-100">Register Now</a>
                            </div>
                        </form>
                    </div>
                </div>
