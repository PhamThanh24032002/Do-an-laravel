                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="basic-login">
                        ...
                        <form action="" method="post">
                            @csrf
                            <label for="name">Địa chỉ Email<span>**</span></label>
                            <input id="name" name="email" type="text" placeholder="...@gmail.com" />
                            @if($errors->has('email'))
                                <div>
                            ...
                            <button type="submit" class="os-btn os-btn-black w-100">Xác nhận email</button>
                        </form>
                    </div>
                </div>
            </div>
