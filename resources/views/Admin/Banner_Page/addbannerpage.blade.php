...
<div class="page-body">
    ...
    <form action="{{route('banner_page.store')}}" method="POST" enctype="multipart/form-data">
    @csrf
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Thêm Mới Banner Pages</h5>
                                </div>
                                <div class="card-body">
                                    <form class="theme-form">
                                        <div class="mb-3">
                                            <label class="col-form-label pt-0" >Chữ Giữa Ảnh</label>
                                            <input class="form-control" value="{{old('content')}}" name="content" type="text" placeholder="Tiêu Đề">
                                        ...
                                        <label class="col-form-label col-sm-3 pt-0"> banner pages</label>
                                            <select name="page" id="input" class="form-control" required="required">
                                                ...
                                                <option value="shop_detail">shop_detail</option>
                                                <option value="view_cart">view_cart</option>
                                                <option value="Order_History">Order_History</option>
                                                <option value="Order_History_detail">Order_History_detail</option>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h5> Ảnh Bài Viết <i style="cursor: grabbing;" class="fileinput-other ml-2 fa fa-plus"></i></h5>
                                </div>
