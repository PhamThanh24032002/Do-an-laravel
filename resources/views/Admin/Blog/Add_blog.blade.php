                                ...
                                <div class="card-body">
                                    <form class="theme-form">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="title" type="text" value="{{old('title')}}" placeholder="Tiêu Đề">
                                            @if ($errors->has('title'))
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="editor" name="content" type="text" placeholder=" Nội Dung">{{old('content')}}</textarea>
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="blog_category_id" id="">
                                            ...
                                            <option value="{{$cate_blog->id}}">{{$cate_blog->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
