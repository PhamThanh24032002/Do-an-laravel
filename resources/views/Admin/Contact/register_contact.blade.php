        ...
        <div class="row second-chart-list third-news-update">
            ...
            <form action="" method="POST" role="form">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="phone" type="text" class="form-control" id="" placeholder="" value="">
                            @if($errors->has('phone'))
                            <div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="address" type="text" class="form-control" id="" placeholder="" value="">
                ...
                <div class="row" style="margin-top: 50px;">
                    <div class="col-4"></div>
                    <div class="col-4">
                        <button style="width: 100%;" type="submit" class="btn btn-primary">Tạo liên hệ</button>
                    </div>
                    <div class="col-4"></div>
                </div>
            </form>
