    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-xl-5">
                <div class="row">
                    <form action="{{route('category.update',$edit_cate->id)}}" method="POST">
                        @method('PUT')
                        @csrf
                        <input type="hidden" name="id" value="{{$edit_cate->id}}">
                        <div class="col-sm-12">
                            <div class="card">
                                    ...
                                    <form class="theme-form">
                                        <div class="mb-3">
                                            <label class="col-form-label pt-0" for="exampleInputEmail1">Tên Danh
                                                Mục</label>
                                            <input class="form-control" name="name" id="exampleInputEmail1" type="text" value="{{$edit_cate->name}}">
                                            @if ($errors->has('name'))
                                        ...
                                        <select class="form-select digits" name="parent_id" id="parent_id">
                                            
                                            <?php showCategories($listCate, 0, '', $edit_cate->parent_id) ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="form-check radio radio-primary">
                                                    <input class="form-check-input" id="radio11" type="radio" name="status" value="1" {{($edit_cate->status==1)?'checked':''}}>
                                                    <label class="form-check-label" for="radio11">Hiển Thị</label>
                                                </div>
                                                <div class="form-check radio radio-primary">
                                                    <input class="form-check-input" id="radio22" type="radio" name="status" value="0" {{($edit_cate->status==0)?'checked':''}}>
