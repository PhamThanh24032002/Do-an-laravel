...
<div class="page-body">
    ...
    <form action="{{route('slider.update',$old_slider->id)}}" method="POST" enctype="multipart/form-data">
        @method('PUT')
                                ...
                                <div class="card-body">
                                    <form class="theme-form">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" value="{{$old_slider->name}}" name="name" type="text" placeholder="Tiêu Đề">
                                            @if ($errors->has('name'))
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="form-check radio radio-primary">
                                                    <input class="form-check-input" id="radio11" type="radio" name="status" value="1" {{($old_slider->status == 1)?'checked':''}}>
                                                    <label class="form-check-label" for="radio11">Hiển Thị</label>
                                                </div>
                                                <div class="form-check radio radio-primary">
                                                    <input class="form-check-input" id="radio22" type="radio" name="status" value="0" {{($old_slider->status == 0)?'checked':''}}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control"  name="link" type="text" placeholder=" Nội Dung">{{$old_slider->link}}</textarea>
                                            @if ($errors->has('link'))
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="position" type="text"  value="{{$old_slider->position}}" placeholder="Nhập Từ 1-> 5, Tối đa là 5" style="width:50%">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h5> Ảnh Bài Viết </h5>
                                    <img src="{{url('imageslider')}}/{{$old_slider->image}}" width="100%" alt="{{$old_slider->image}}">
