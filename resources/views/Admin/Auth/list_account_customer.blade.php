...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h3>Danh sách tài khoản Customer</h3>
                </div>
                <div class="col-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Tài khoản Customer</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="card-title mb-0">Danh sách Customer</h4>
                            </div>
                        ...
                        <table class="table card-table table-vcenter
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="status-icon bg-success"></span> {{$value->phone}}
                                    <td>{{($value->status==0) ? "Mở" : "Khóa"}}</td>
                                    <td>
                                    
                                    <td class="text-end">
                                        <a class="btn btn-primary btn-sm" href="{{route('show.detail.account.customer',$value->id)}}" data-bs-original-title="" title=""><i class="fa fa-pencil"></i> Sửa</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
