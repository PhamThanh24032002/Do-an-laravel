            ...
            <div class="col-xl-4 card">
                ...
                <div class="card-body">
                        ...
                        <div class="profile-title">
                            <div class="media" style="align-items: center;">
                                ...
                                <div class="media-body" style="margin-left: 25px;">
                                    <h5 class="mb-1">{{$detail_admin->name}}</h5>
                                    <p>@if($detail_admin->role==0)
                                        ADMIN
                                        @elseif($detail_admin->role==1)
                                        CENSOR
                                        @elseif($detail_admin->role==2)
                                        CONTENT CREATORS
                                        @endif
                                    </p>
                                </div>
                    ...
                    <div>
                        ...
                        <div class="form-control" value="" placeholder="your-email@domain.com" data-bs-original-title="" title="">{{$detail_admin->email}}</div>
                    </div>
                    <div>
                    ...
                    <div>
                        <label class="form-label" style="font-weight: bold; margin-top:15px">Website</label>
                        <div class="form-control" data-bs-original-title="" title="">http://Uplor.com</div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-control" type="text" data-bs-original-title="" title="">{{$detail_admin->name}}</div>
                                </div>
                                <div class="col-12">
                                    <label class="form-label" style="font-weight: bold; margin-top:15px">Địa chỉ email: </label>
                                    <div class="form-control" type="email" data-bs-original-title="" title="">{{$detail_admin->email}}</div>
                                </div>
                                <div class="col-md-5">
                                    ...
                                    <select name="status" class="form-control btn-square">
                                        <option {{($detail_admin->status==0) ? "selected" :""}} value="0"> Mở</option>
                                        <option {{($detail_admin->status==1) ? "selected" :""}} value="1">Khóa</option>
                                    </select>
                                </div>
                                <div class="col-md-5">
                                    <label class="form-label" style="font-weight: bold; margin-top:15px">Quyền hạn tài khoản: </label>
                                    <select name="role" class="form-control btn-square">
                                        <option {{($detail_admin->role==0) ? "selected" :""}} value="0">Admin</option>
                                        <option {{($detail_admin->role==1) ? "selected" :""}} value="1">Censor</option>
                                        <option {{($detail_admin->role==2) ? "selected" :""}} value="2">Content Creators</option>
