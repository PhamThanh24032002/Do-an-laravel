...
<div class="page-body">
    ...
    <form action="{{route('logo.update',$old_logo->id)}}" method="POST" enctype="multipart/form-data">
        @method('PUT')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="form-check radio radio-primary">
                                                    <input class="form-check-input" id="radio11" type="radio" name="status" value="1" {{($old_logo->status == 1)?'checked':''}}>
                                                    <label class="form-check-label" for="radio11">Hiển Thị</label>
                                                </div>
                                                <div class="form-check radio radio-primary">
                                                    <input class="form-check-input" id="radio22" type="radio" name="status" value="0" {{($old_logo->status == 0)?'checked':''}}>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h5> Ảnh Bài Viết </h5>
                                    <img src="{{url('imagelogo')}}/{{$old_logo->image}}" width="100%" alt="{{$old_logo->image}}">
