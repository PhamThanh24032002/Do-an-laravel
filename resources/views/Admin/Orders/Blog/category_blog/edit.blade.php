                                ...
                                <div class="card-body">
                                    <form class="theme-form">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="name" id="exampleInputEmail1" type="text" value="{{$edit_cate_blog->name}}">
                                            @if ($errors->has('name'))
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="form-check radio radio-primary">
                                                    <input class="form-check-input" id="radio11" type="radio" name="status" value="1" {{($edit_cate_blog->status==1)?'checked':''}}>
                                                    <label class="form-check-label" for="radio11">Hiển Thị</label>
                                                </div>
                                                <div class="form-check radio radio-primary">
                                                    <input class="form-check-input" id="radio22" type="radio" name="status" value="0" {{($edit_cate_blog->status==0)?'checked':''}}>
